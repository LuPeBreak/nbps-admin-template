...
- `data-table-pagination-utils.ts` (shared) — Pure range calculation for zero results and defensive page clamping.
...
- `data-table-constants.ts` (shared) — Pagination limits reused by URL parsers and server validation.
